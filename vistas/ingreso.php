              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title colorletra text1">Ingreso <i class="fa fa-cart-plus fa-2x" aria-hidden="true" onclick="mostrarform(true)"></i> <a href="../reportes/rptingresos.php" class="colorletra" target="_blank"><i class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i></a></h1>
                    ...
                    <div class="panel-body" style="height: 100%;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            <label class="text1">Proveedor(*):</label>
                            <input type="hidden" name="idingreso" id="idingreso">
                            <select id="idproveedor" name="idproveedor" class="form-control text1 selectpicker" data-live-search="true" required>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 style="color: black;">Seleccione un Artículo</h4>
        </div>
        <div class="modal-body table-responsive text1">
