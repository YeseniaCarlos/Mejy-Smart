              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title colorletra text1">Proveedor <i class="fa fa-cart-plus fa-2x" aria-hidden="true" onclick="mostrarform(true)"></i> <a href="../reportes/rptproveedores.php" class="colorletra" target="_blank"><i class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i></a></h1>
