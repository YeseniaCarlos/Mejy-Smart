              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title colorletra">Cliente <img src="../files/icono/compra.png" alt="" width="60" height="60" onclick="mostrarform(true)"><a href="../reportes/rptclientes.php" target="_blank"><img src="../files/icono/reporte.png" alt="" width="60" height="60"></a></h1>
